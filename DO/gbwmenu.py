...
def create_custom_theme():
    ...
    sg.theme_add_new('MyCustomTheme', DO)
...
layout = [
    [sg.Text('Welkom bij de Digitaal Ondertekenen Tool Selecteerder', justification='center', font=font, text_color=button_text_color, pad=(0,10))],
    [sg.Button('Start QR Code Generator', key='START_QR', button_color=('white', button_text_color), font=button_font)],
#     sg.Stretch(),
#     sg.Button('Start Countdown Timer', key='START_TIMER', button_color=('white', button_text_color), font=button_font)],
...
# Maak het Window
window = sg.Window('Digitaal Ondertekenen Selecteerder', layout, size=(gewenste_breedte, gewenste_hoogte), grab_anywhere=True, finalize=True)
